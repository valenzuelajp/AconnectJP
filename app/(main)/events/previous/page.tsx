                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold tracking-tight text-slate-900">
                                Previous <span className="text-slate-600">Events</span>
                            </h1>
                            <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-widest">
                                Event Archives & History
                            </p>
                        </div>
                    </div>
                    <div className="bg-slate-100 text-slate-700 px-3 py-1 rounded-full text-xs font-bold border border-slate-200">
            ...
            <main className="max-w-6xl mx-auto px-6 py-12">
                <div className="bg-white p-2 rounded-2xl shadow-sm border border-slate-200 mb-12 flex flex-col md:flex-row gap-2">
                    <div className="flex-grow flex items-center px-4 gap-3 border-r border-slate-100">
                        ...
                        <input
                            type="text"
                            placeholder="Search past events, workshops, or topics..."
                            value={search}
                    ...
                    <div className="flex gap-2 p-1">
                        <select
                            ...
                            className="bg-slate-50 border-none text-slate-600 text-xs font-bold py-2 px-4 rounded-xl outline-none focus:ring-2 focus:ring-slate-600/20 cursor-pointer"
                        >
                    ...
                    <div className="space-y-4">
                        {filteredEvents.length > 0 ? (
                            filteredEvents.map((event) => (
                                <EventCard key={event.id} event={event} onAction={fetchPreviousEvents} />
                            ))
                        ) : (
                            <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-slate-300">
                                ...
                                <h3 className="text-lg font-bold text-slate-900">No previous events found</h3>
