...
async function writeAppTypeDeclarations({ baseDir, distDir, distDirRoot, imageImportsEnabled, hasPagesDir, hasAppDir }) {
   ...
   */ const lines = [
    ...
    const routeTypesPath = _path.default.posix.join(typesDistDir.replaceAll(_path.default.win32.sep, _path.default.posix.sep), 'types/routes.d.ts');
