...
export async function writeAppTypeDeclarations({ baseDir, distDir, distDirRoot, imageImportsEnabled, hasPagesDir, hasAppDir }) {
   ...
   */ const lines = [
    ...
    const routeTypesPath = path.posix.join(typesDistDir.replaceAll(path.win32.sep, path.posix.sep), 'types/routes.d.ts');
