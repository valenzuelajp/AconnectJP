 ...
 */ async function generateDynamicFlightRenderResult(req, ctx, requestStore, options) {
    ...
    const onError = createReactServerErrorHandler(dev, isBuildTimePrerendering, workStore.reactServerErrorsByDigest, onFlightDataRenderError);
...
async function renderToStream(requestStore, req, res, ctx, tree, formState, postponedState, metadata, createRequestStore, devFallbackParams) {
    ...
    return getTracer().withSpan(renderSpan, async ()=>{
        ...
        const serverComponentsErrorHandler = createReactServerErrorHandler(dev, isBuildTimePrerendering, reactServerErrorsByDigest, onHTMLRenderRSCError, renderSpan);
        ...
        const htmlRendererErrorHandler = createHTMLErrorHandler(dev, isBuildTimePrerendering, reactServerErrorsByDigest, allCapturedErrors, onHTMLRenderSSRError, renderSpan);
...
async function prerenderToStream(req, res, ctx, metadata, tree, fallbackRouteParams) {
    ...
    const serverComponentsErrorHandler = createReactServerErrorHandler(dev, isBuildTimePrerendering, reactServerErrorsByDigest, onHTMLRenderRSCError);
    function onHTMLRenderSSRError(err) {
        if (reportErrors) {
    ...
    const allCapturedErrors = [];
    const htmlRendererErrorHandler = createHTMLErrorHandler(dev, isBuildTimePrerendering, reactServerErrorsByDigest, allCapturedErrors, onHTMLRenderSSRError);
