...
export function createServerParamsForServerSegment(underlyingParams, workStore, varyParamsAccumulator = null) {
    const workUnitStore = workUnitAsyncStorage.getStore();
    if (workUnitStore) {
        switch(workUnitStore.type){
            case 'prerender':
...
function createRuntimePrerenderParams(underlyingParams, workUnitStore, varyParamsAccumulator) {
    const underlyingParamsWithVarying = varyParamsAccumulator !== null ? createVaryingParams(varyParamsAccumulator, underlyingParams) : underlyingParams;
    return delayUntilRuntimeStage(workUnitStore, makeUntrackedParams(underlyingParamsWithVarying));
}
