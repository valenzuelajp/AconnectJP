...
export function createServerSearchParamsForServerPage(underlyingSearchParams, workStore, varyParamsAccumulator = null) {
    const workUnitStore = workUnitAsyncStorage.getStore();
    if (workUnitStore) {
        switch(workUnitStore.type){
            case 'prerender':
...
function createRuntimePrerenderSearchParams(underlyingSearchParams, workUnitStore, varyParamsAccumulator) {
    ...
    return delayUntilRuntimeStage(workUnitStore, makeUntrackedSearchParams(underlyingSearchParamsWithVarying));
}
