...
import { collectAppFiles, collectPagesFiles, processAppRoutes, processPageRoutes, createPagesMapping } from '../../../build/entries';
            ...
            if (appDir && (!routerType || routerType === 'app')) {
                try {
                    ...
                    if (appPaths.length > 0) {
                        ...
                        const { appRoutes, appRouteHandlers } = processAppRoutes(mappedAppPages, validFileMatcher, projectPath, isSrcDir || false);
                        // Add app page routes
            ...
            if (pagesDir && (!routerType || routerType === 'pages')) {
                try {
                    ...
                    if (pagePaths.length > 0) {
                        ...
                        const { pageRoutes, pageApiRoutes } = processPageRoutes(mappedPages, projectPath, isSrcDir || false);
                        // Add page routes
