...
function buildNodejsLowPriorityPath(filename, buildId, dev, deploymentId) {
    if (!dev && deploymentId) {
        // Leverage skew protection
        return `${_constants.CLIENT_STATIC_FILES_PATH}/${filename}`;
    } else {
    ...
    createAssets(compiler, compilation) {
        ...
        return createAssetsSpan.traceFn(()=>{
            ...
            if (!this.isDevFallback) {
                ...
                const buildManifestPath = buildNodejsLowPriorityPath('_buildManifest.js', this.buildId, this.dev, this.deploymentId);
                const ssgManifestPath = buildNodejsLowPriorityPath('_ssgManifest.js', this.buildId, this.dev, this.deploymentId);
