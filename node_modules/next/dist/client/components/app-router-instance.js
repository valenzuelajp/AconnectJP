 ...
 */ function gesturePush(href, options) {
    if (process.env.__NEXT_GESTURE_TRANSITION) {
        ...
        const forkedGestureState = (0, _navigation.navigate)(state, url, currentUrl, state.renderedSearch, state.cache, state.tree, state.nextUrl, freshnessPolicy, shouldScroll, 'push');
