...
async function cache(kind, id, boundArgsLength, originalFn, args) {
    ...
    if (renderResumeDataCache) {
        ...
        if (cachedEntry !== undefined) {
            let existingEntry = await cachedEntry;
            ...
            if (existingEntry !== undefined) {
                ...
                if (existingEntry.tags.some((tag)=>isRecentlyRevalidatedTag(tag, workStore)) || implicitTags.some((tag)=>isRecentlyRevalidatedTag(tag, workStore))) {
